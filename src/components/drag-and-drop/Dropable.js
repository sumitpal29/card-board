    ...
    (e) => {
      ...
      if (
        ...
        if (dropElementType === "column" && dragElementType === "card") {
          ...
          const elDate = constGetParentType(document.getElementById(draggedCardID))
          const {columnConfig} = elDate
          ...
          if(oldColumnIndex !== newColumnIndex) {
            ...
            const cardIndex = stateContext.currentBoardState.innerChildren[oldColumnIndex].innerChildren.findIndex(
              (el) => {
            ...
            stateContext.dispatch({
              ...
              value: {
                oldColumnIndex, newColumnIndex, cardIndex, newIndex: 'last'
              },
            });
          }

          console.log(
            `card droped in a column whose index is ${newColumnIndex} --- ${draggedCardID} --- ${oldColumnIndex}`, elDate
          );
